...
public class TaskDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TaskDescriptor() {
        ...
        //-- _tableList
        desc = new XMLFieldDescriptorImpl(Table.class, "_tableList", "table", NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
        ...
        //-- _taskTimeList
        desc = new XMLFieldDescriptorImpl(TaskTime.class, "_taskTimeList", "taskTime", NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Task target = (Task) object;
                    target.addTaskTime( (TaskTime) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _taskTimeList
        fieldValidator = new FieldValidator();
        fieldValidator.setMinOccurs(0);
        desc.setValidator(fieldValidator);
        
    } //-- cn.com.youtong.apollo.task.xml.TaskDescriptor()
    ...
    **/
    ...
    {
        return cn.com.youtong.apollo.task.xml.Task.class;
