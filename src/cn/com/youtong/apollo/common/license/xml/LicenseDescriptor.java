...
**/
public class LicenseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public LicenseDescriptor() {
        ...
        //-- _machinecode
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_machinecode", "machinecode", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    License target = (License) object;
                    target.setMachinecode( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _machinecode
        fieldValidator = new FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            StringValidator sv = new StringValidator();
        ...
        //-- _regkey
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_regkey", "regkey", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    License target = (License) object;
                    target.setRegkey( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- cn.com.youtong.apollo.common.license.xml.LicenseDescriptor()
    ...
    **/
    ...
    {
        return cn.com.youtong.apollo.common.license.xml.License.class;
