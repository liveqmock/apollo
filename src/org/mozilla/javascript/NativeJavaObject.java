...
public class NativeJavaObject implements Scriptable, Wrapper, Externalizable {
     ...
     * 判断指定的属性是否在当前的对象中
     * @param name 属性的名称
     * @param start found from here
     * @return 指定的属性在当前的对象中，返回true；否则返回false
     */
    public boolean has(String name, Scriptable start) {
        boolean isInMembers = members.has(name, false);
        if(!isInMembers && javaObject instanceof cn.com.youtong.apollo.script.ScriptObject)
        {
            //判断是否在ScriptObject中
            cn.com.youtong.apollo.script.ScriptObject obj =
                (cn.com.youtong.apollo.script.ScriptObject) javaObject;
            isInMembers = obj.isField(name);
        }
        return isInMembers;
    }
    ...
    public boolean has(int index, Scriptable start) {
		...
		if(javaObject instanceof cn.com.youtong.apollo.script.ScriptArray)
		{
			//判断是否在ScriptArray中
			cn.com.youtong.apollo.script.ScriptArray obj =
                (cn.com.youtong.apollo.script.ScriptArray) javaObject;
