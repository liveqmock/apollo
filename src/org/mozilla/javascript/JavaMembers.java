...
class JavaMembers {
	...
	private static Log log = LogFactory.getLog("Script");
	...
	/**
	 * zhou modify: if javaObject is instance of
	 * cn.com.youtong.apollo.script.ScriptObject,
	 * and field name not found try to acces by ScriptObject's
	 * dynamic fields.
	 *
	 * @param scope
	 * @param name
               ...
               boolean isStatic)
    {
        ...
        if (member == null)
		{
            ...
            if (member == null)
			{
				//try to access field from ScriptObject dynamic fields
				if(javaObject instanceof cn.com.youtong.apollo.script.ScriptObject)
				{
					cn.com.youtong.apollo.script.ScriptObject obj =
						(cn.com.youtong.apollo.script.ScriptObject) javaObject;
					if(obj.isField(name))
					{
						Object value = obj.s_getField(name);
						if(log.isDebugEnabled())
						{
							log.debug("get table field: " + javaObject + "."
									  + name + "(" + value + ")");
						}
						return value;
					}
	 ...
	 * @param value
	 * @param isStatic
	 * @see cn.com.youtong.apollo.script.ScriptObject
	 */
                    ...
                    Object value, boolean isStatic)
    {
        ...
        if (member == null)
		{
			...
			if(javaObject instanceof cn.com.youtong.apollo.script.ScriptObject )
			{
				...
				if(obj.isField(name))
				{
					obj.s_setField(name, value);
					if(log.isDebugEnabled())
					{
						log.debug("set table field: " + javaObject + "." + name
								  + " = " + value);
					}
