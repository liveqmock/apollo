...
%>
      ...
      window.location="../servlet/log?operation=<%= cn.com.youtong.apollo.servlet.LogServlet.SHOW_DATA_LOG_PAGE %>";
      }
      function gotoPrePage(){
      window.location="../servlet/log?operation=<%= cn.com.youtong.apollo.servlet.LogServlet.SHOW_DATA_LOG_PAGE %>"+"&curPage="+"<%=String.valueOf(curPg-1)%>";
      }
      ...
      window.location="../servlet/log?operation=<%= cn.com.youtong.apollo.servlet.LogServlet.SHOW_DATA_LOG_PAGE %>"+"&curPage="+"<%=maxPage%>";
      }
      </script>
<%}else{%>
    <tr>
      <td colspan="5" align="center"><img src="../img/infomation.bmp">&nbsp;  没有日志数据</td>
    </tr>
<%}%>
  </table>
