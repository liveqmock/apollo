  ...
  <table width=100% border=0>
    <tr>
      <td>
                    <table width=100%>
                    <tr align=center>
                     <td colspan=3><img src="../img/infomation.bmp">&nbsp;未上报单位数<%= maxRowCount + "/" + allUnitCount %>，未上报率<%= Convertor.double2Percent(percent) %></td>
                    </tr>
                    ...
                    %>
                            ...
                            <td><%=form.getUnit().getUnitCode()%></td>
...
window.location="../servlet/analyse?operation=<%= cn.com.youtong.apollo.servlet.AnalyseServlet.SHOW_NOT_FILLSTATE_RESULT%>"+"&taskTimeID="+"<%=taskTimeID%>";
}
function gotoPrePage(){
window.location="../servlet/analyse?operation=<%= cn.com.youtong.apollo.servlet.AnalyseServlet.SHOW_NOT_FILLSTATE_RESULT%>"+"&curPage="+"<%=String.valueOf(curPg-1)%>"+"&taskTimeID="+"<%=taskTimeID%>";
}
function gotoNextPage(){
window.location="../servlet/analyse?operation=<%= cn.com.youtong.apollo.servlet.AnalyseServlet.SHOW_NOT_FILLSTATE_RESULT%>"+"&curPage="+"<%=String.valueOf(curPg+1)%>"+"&taskTimeID="+"<%=taskTimeID%>";
}
function gotoLastPage(){
window.location="../servlet/analyse?operation=<%= cn.com.youtong.apollo.servlet.AnalyseServlet.SHOW_NOT_FILLSTATE_RESULT%>"+"&curPage="+"<%=maxPage%>"+"&taskTimeID="+"<%=taskTimeID%>";
}
</script>
</body>
</html>
