...
<script language="JavaScript">
	...
	{
		reportframe.location.replace('../do/report?action=view');
	}
	function _uploadManager()
	{
		reportframe.location.replace('../do/report?action=uploadview');
	}
			...
			<table cellspacing=0 cellpadding=5px border=0 style="width:100%;height:100%">
								...
								<td>
									<table cellspacing=2 cellpadding=0 border=0 style="width:100%;height:100%">
										<tr style="height:20px">
											...
											<td style="color:blue;cursor:hand" onclick="javascript:_templateManager();">模板查看
											</td>
										</tr>
										<tr style="height:20px">
											<td>&nbsp;</td>
											...
											<td style="color:blue;cursor:hand" onclick="javascript:_uploadManager();">上传模板
											</td>
										</tr>
										<tr style="height:20px">
											<td>&nbsp;</td>
											...
											<td style="color:blue;cursor:hand" onclick="javascript:_deleteManager();">删除模板
											</td>
										</tr>
										<tr>
											<td colspan=3>&nbsp;
				...
				<tr>
					<td>
						...
						<table cellspacing=0 cellpadding=0 border=0 style="width:100%;height:100%;border-collapse:collapse;">
							<tr style="height:20px">
								<td style="font-size:12px;color:blue;font-weight:bolder">&nbsp;模板列表
								</td>
							</tr>
							<tr>
								<td>
								<iframe width="100%" height="100%" frameborder="0" name="reportlist" src="../do/report?action=templatelist" scrolling="auto"></iframe>
								</td>
							</tr>
						</table>
						</div>
