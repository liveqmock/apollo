...
<%!
    ...
    public void listContextPath(String title, JspWriter out, String path, String comment)  throws IOException {
        listVersions(title, out,scanDir(this.getServletConfig().getServletContext().getRealPath(path)), comment);
    }
...
<tr>
    ...
    <td><%= this.getServletConfig().getServletContext().getServerInfo() %></td>
    <td><%= this.getServletConfig().getServletContext().getMajorVersion() %></td>
    <td><%= this.getServletConfig().getServletContext().getMinorVersion() %></td>
</tr>
<tr>
    <td>Java VM</td>
...
String container=this.getServletConfig().getServletContext().getServerInfo();
